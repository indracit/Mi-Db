...
$sql ="select SerialNo,RRN,GatewayRRN,VendorID,RespToClient,Amount,ServiceName,ONUS,ServerTime from txn_txnsummary where vendorid not in ('17','01') order by 1 desc limit 32" ;
